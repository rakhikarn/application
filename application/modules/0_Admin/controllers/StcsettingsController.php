<?php
class Admin_StcsettingsController extends Admin_Controller_Action_Abstract
{
    var $dao; 
    var $form;
    ...
    {
        $this->dao = new Admin_Model_DbTable_Stcsettings();
        $this->form = new Admin_Form_Stcsettings(); 
        parent::preDispatch();
    }
